...
void median()
{
	...
	else if ((int)all_lidar_distance_in_boundingbox.size() % 2 == 1)
	{
		...
		if (container)
		{
			...
			//median_distance_container[int(NumFromMedian / 2)] = all_lidar_distance_in_boundingbox[(int)((int)all_lidar_distance_in_boundingbox.size() / 2)];
			//median_num_container[int(NumFromMedian / 2)].x = all_point_cloud_in_a_boundingbox_3D[(int)((int)all_lidar_distance_in_boundingbox.size() / 2)].x;
	...
	else if((int)all_lidar_distance_in_boundingbox.size() % 2 == 0)
	{
		...
		else if (person)
		{
			...
			//median_distance_person[int(NumFromMedian / 2)] = (all_lidar_distance_in_boundingbox[(int)((int)all_lidar_distance_in_boundingbox.size() / 2) - 1] + all_lidar_distance_in_boundingbox[(int)((int)all_lidar_distance_in_boundingbox.size() / 2)]) / 2;
			//median_num_person[int(NumFromMedian / 2)].x = (all_point_cloud_in_a_boundingbox_3D[((int)all_lidar_distance_in_boundingbox.size() / 2) - 1].x + all_point_cloud_in_a_boundingbox_3D[(int)all_lidar_distance_in_boundingbox.size() / 2].x) / 2;
