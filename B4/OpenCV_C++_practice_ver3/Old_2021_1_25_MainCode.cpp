...
//vector<vector<vector<struct tracking_object_type>>> Objects_all;
...
int yolo_lidar() {
	...
	ofs_container.open("D:\\MyTemp\\all_median_points_mine_container_57_1m.txt");
	...
	ofs_person.open("D:\\MyTemp\\all_median_points_mine_person_57_1m.txt");
...
int median()
{
	...
	if ((int)all_lidar_distance_in_boundingbox.size() == 0)
	{
		...
		for (int b = 0; b < NumFromMedian; b++)
		{
			...
			/*if (b == int(NumFromMedian / 2))
			{
				in_object_container.x = median_num_container[b].x;
				in_object_container.y = median_num_container[b].y;
				in_object_container.z = median_num_container[b].z;

				IN_Objects_buf_container.push_back(in_object_container);



				in_object_person.x = median_num_person[b].x;
				in_object_person.y = median_num_person[b].y;
				in_object_person.z = median_num_person[b].z;
...
int vector_test_sample(FILE *gid)
{
	...
	//Objects_all.push_back(Objects_container);
	...
	//Objects_all.push_back(Objects_person);




	
	//show the result of moving trajectory using gnuplot.
	show_objects_pose_via_gnuplot(gid);
