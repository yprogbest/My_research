...
int main(int argc, char **argv)
{
	...
	hThread_gnuplot = (HANDLE)_beginthreadex(NULL, 0, thread_gnuplot, "gnuplot", 0, NULL); //スレッドの開始(https://www.wabiapp.com/WabiSampleSource/windows/begin_thread_ex.html)
