...
#### 3. 深層学習を用いたステレオマッチングシステムの開発(12/17)
- [Slide](https://github.com/yuki-research/My_research/files/7733836/1217_P_Masuda.pdf)
- [Report](https://github.com/yuki-research/My_research/files/7733839/1217_W_Masuda.pdf)

##### 要旨
　本研究では，ステレオカメラを用いて深層学習による距離推定を可能とするシステムの開発を行った．本システムは，深層学習を用いたステレオ視の一つであるPSMNetを用いた．実験では，三重大学農場内のみかん畑内をステレオカメラで撮影し，これまでの開発で用いられてきたステレオ視とPSMNetの比較を行った．実験を通して，今回は既存のデータセットで学習を行ったことから，計測結果に誤差が生じる結果となった．今後は，独自のデータセットを作成する方法を調べ，学習を行うことで，この問題を解決していく．

##### 実験結果
- 従来の手法とPSMNetの視差画像の結果を示す．濃い白ほどカメラとの距離が近く，黒になるほどカメラとの距離が遠くなる．従来の手法では，カメラから近い場所でやや黒い結果が得られ，実際の深度とは異なる結果が得られた個所が存在する．一方，PSMNetの視差画像では，カメラから遠くなるほど色が白から黒へ変化していることから，良好な視差画像を取得することが出来ている様に見える．しかし，画像の右上の箇所では，カメラから遠い場所において，濃い白色で表示されていることや全体的に視差が薄いことから，深度情報を上手く取得出来ていない可能性が考えられる．<br>![image](https://user-images.githubusercontent.com/82224433/146518492-cf274045-06aa-47c0-8e72-dda1420479f5.png)<br>従来の手法の視差画像<br>![image](https://user-images.githubusercontent.com/82224433/146518594-4c65f7f4-be2d-4493-9f1a-20f40a14b370.png)<br>PSMNetの視差画像
- 従来の手法とPSMNetの深度（奥行き）情報の結果を示す．従来の手法では値が取得出来ていない箇所や誤差が生じている個所が存在する．一方で，PSMNetでは，従来の手法に比べて，点群を取得することはできているが，深度情報が良好に取得されず，平面画像に近い結果となった．これは，事前に学習されたデータセットを用いたからではないかと考える．今回は，自動運転など場面で使われるKITTIデータセットを用いたため，今後は，自作のデータセットを用いることで，より頑健な深度情報を得ることが出来るのではないかと考える．<br>![image](https://user-images.githubusercontent.com/82224433/146518714-bd6533f5-c3eb-481a-a6d0-8ba3fa84cd99.png)<br>従来の手法の深度情報<br>![image](https://user-images.githubusercontent.com/82224433/146518767-556786ec-7481-41d3-887b-c953c2e541ca.png)<br>PSMNetを用いた深度情報


#### 【The 27th Tri-U International Joint Seminar and Symposium】Object Tracking in Workspace Using a LiDAR-camera Fusion System for Human-collaborative Agricultural Robots(11/3)
- [Slide](https://github.com/yuki-research/My_research/files/7422965/presentation_slide_part5.pdf)
